...
if(isset($_POST['code']) && isset($_POST['name']) && isset($_POST['abbreviation']) && isset($_POST['section']) && isset($_POST['level']) && isset($_POST['status'])){
    $grado = new grado();
    ...
    if($error != 0){
        ...
        $response = $grado->addDegree($_POST['code'], $_POST['section'], $_POST['name'], $_POST['status'], $_POST['level'], $_POST['abbreviation']);
    }
